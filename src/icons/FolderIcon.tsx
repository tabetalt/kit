...
export interface FolderIconProps extends BoxProps {
  size?: number;
}

const FolderIcon: React.FC<FolderIconProps> = ({ size = 30, ...props }) => (
  <Box
    as="svg"
    // @ts-expect-error
