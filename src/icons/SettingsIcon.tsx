...
export interface SettingsIconProps extends BoxProps {
  size?: number;
}

const SettingsIcon: React.FC<SettingsIconProps> = ({ size = 30, ...props }) => (
  <Box
    as="svg"
    // @ts-expect-error
